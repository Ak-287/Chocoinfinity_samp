...
const product = {
  ...
  sizes: [
    { name: "1 piece", inStock: true },
    { name: "1/2kg", inStock: true },
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">4521 Ratings</p>
                  <p
              ...
              <form className="mt-10">
                ...
                <Button color ="secondary" variant="contained" sx={{px:"2rem",py:"1rem",bgcolor:"#69359c" }}>
                  Add to Bag
                </Button>
              </form>
            </div>
            ...
            <Grid container spacing={7}>
                ...
                <Grid item xs={5}>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="opacity-60">594432 Ratings</p>
                  </div>
                  ...
                  <Box className="mt-5 space-y-3">
                      ...
                      <Grid container  alignItems="center" gap={2}>
                        ...
                        <Grid item xs={7}>
                          <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7, '& .MuiLinearProgress-bar': {bgcolor: 'yellow', },}}variant="determinate" value={15} ></LinearProgress>
                          </Grid>
                      </Grid>
                      ...
                      <Grid container  alignItems="center" gap={2}>
                        ...
                        <Grid item xs={7}>
                          <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7}}variant="determinate" value={10} color="warning"></LinearProgress>
                          </Grid>
                      </Grid>
                      ...
                      <Grid container  alignItems="center" gap={2}>
                        ...
                        <Grid item xs={7}>
                          <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7}}variant="determinate" value={5} color="error"></LinearProgress>
                          </Grid>
                      </Grid>
                  </Box>
                </Grid>
